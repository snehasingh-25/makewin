...
router.post("/", verifyToken, uploadReelFiles.fields([
  ...
  try {
    ...
    const { title, url, videoUrl, thumbnail, platform, isActive, order, isTrending, isFeatured, discountPct } = req.body;
...
router.put("/:id", verifyToken, uploadReelFiles.fields([
  ...
  try {
    ...
    const { title, url, videoUrl, thumbnail, platform, isActive, order, isTrending, isFeatured, discountPct, existingVideoUrl, existingThumbnail } = req.body;
