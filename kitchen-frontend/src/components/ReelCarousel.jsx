        ...
        <div className="relative overflow-hidden rounded-2xl shadow-lg bg-black">
          ...
          <div className="relative w-full" style={{ paddingBottom: "177.78%" }}>
            ...
            <div className="absolute top-3 left-3 flex items-center gap-2">
              {isFeatured && (
                <span className="px-2 py-1 text-xs font-bold rounded-full bg-olive text-white shadow">
                  Featured
                </span>
              )}
              {reel.isTrending && (
                <span className="px-2 py-1 text-xs font-bold rounded-full bg-cream/90 text-gray-900 shadow">
                  Trending
                </span>
              )}
              {discountPct ? (
              ...
              <div className="flex items-end gap-3">
                {productImg && (
                  <img
                    ...
                    className="w-12 h-12 rounded-xl object-cover shadow bg-cream"
                    loading="lazy"
                    decoding="async"
                    width={48}
                    height={48}
