...
const WHATSAPP_LINK = "https://wa.me/919166166190?text=" + encodeURIComponent("Hello! I need assistance with Makewin.");
...
const WELCOME_MESSAGE = {
  ...
  quickOptions: [
    ...
    { label: "Gifts for Loved Ones", value: "Gifts for loved ones" },
    ...
    { label: "Type your requirement", value: "" },
  ],
};
    ...
    <>
      ...
      >
        {!isOpen ? (
          ...
          <svg className="w-5 h-5 md:w-6 md:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ color: "var(--olive)" }}>
      ...
      {isOpen && (
        <div
          className="fixed inset-x-0 bottom-0 md:bottom-24 md:right-8 md:left-auto z-50 w-full md:w-96 h-[100dvh] md:h-[600px] bg-cream md:rounded-2xl shadow-2xl flex flex-col border-2 md:border-2 border-t-2 overflow-hidden"
        ...
        >
          ...
          >
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <div>
                <h3 className="font-bold text-sm md:text-base" style={{ color: "var(--olive)" }}>
                  Gift Buddy
                </h3>
            ...
            <button onClick={() => setIsOpen(false)} className="p-1 rounded-lg hover:bg-cream/50 transition">
          ...
          <div className="flex-1 overflow-y-auto p-3 md:p-4 space-y-3 md:space-y-4" style={{ backgroundColor: "white" }}>
            {messages.map((msg) => (
              <div key={msg.id} className={`flex ${msg.sender === "user" ? "justify-end" : "justify-start"}`}>
                <div
                  className={`max-w-[85%] md:max-w-[90%] rounded-2xl px-3 md:px-4 py-2 ${msg.sender === "user" ? "rounded-br-sm" : "rounded-bl-sm"
                    }`}
                  style={{
                    backgroundColor: msg.sender === "user" ? "var(--primary)" : "oklch(96% .02 340)",
                    color: "var(--olive)",
                  }}
                >
            ...
            {loading && (
              <div className="flex justify-start">
                <div
                  ...
                  style={{ backgroundColor: "oklch(96% .02 340)", color: "var(--olive)" }}
                >
          ...
          <div
            ...
            style={{ borderColor: "var(--primary)", backgroundColor: "oklch(96% .02 340)" }}
          >
          ...
          <form onSubmit={handleSendMessage} className="p-3 md:p-4 border-t-2 shrink-0" style={{ borderColor: "var(--primary)" }}>
            <div className="flex gap-2">
              <input
                ...
                style={{ borderColor: "var(--primary)", backgroundColor: "white", color: "var(--olive)" }}
                disabled={loading}
              />
              <button
                type="submit"
