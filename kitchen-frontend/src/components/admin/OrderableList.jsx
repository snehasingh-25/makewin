...
export default function OrderableList({
  ...
  return (
    <div className={`bg-cream rounded-xl shadow-md border ${className}`} style={{ borderColor: 'var(--primary)' }}>
      <div className="p-6 border-b" style={{ borderColor: 'var(--primary)' }}>
        <div className="flex items-center justify-between">
          <h2 className="text-xl font-bold" style={{ color: 'var(--olive)' }}>
            {title || "Items"} ({localItems.length})
          </h2>
          {saving && (
            <div className="flex items-center gap-2 text-sm" style={{ color: 'oklch(50% .02 340)' }}>
              <span className="inline-block w-4 h-4 border-2 border-olive border-t-transparent rounded-full animate-spin" />
              Saving order...
            </div>
          )}
        </div>
      ...
      >
        ...
        >
          <div className="divide-y" style={{ borderColor: 'var(--primary)' }}>
        ...
        <DragOverlay>
          {activeItem ? (
            <div className="bg-cream border-2 rounded-lg p-4 shadow-lg" style={{ borderColor: 'var(--primary)' }}>
