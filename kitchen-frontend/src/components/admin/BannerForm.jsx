        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-olive transition"
              placeholder="e.g., /shop, /category/kitchen-appliances"
            />
          </div>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <button
                ...
                className="px-4 py-2.5 border-2 border-dashed border-gray-300 rounded-lg text-sm font-semibold text-gray-700 hover:border-olive hover:text-olive transition w-full"
              >
