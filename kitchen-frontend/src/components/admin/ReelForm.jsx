  ...
  return (
    <div className="bg-cream rounded-xl shadow-md p-6 mb-6 border border-gray-200">
      ...
      <form ref={formRef} onSubmit={handleSubmit} onKeyDown={handleKeyDown} className="space-y-6">
          ...
          <div className="space-y-3">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-olive transition text-sm"
              />
              {videoFile && (
        ...
        <div className="sticky bottom-0 bg-cream pt-4 pb-2 border-t border-gray-200">
