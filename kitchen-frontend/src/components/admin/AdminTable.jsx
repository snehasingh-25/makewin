        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:items-center">
          <div className="relative">
            <input
              ...
              placeholder="Search…"
              className="w-full sm:w-72 px-4 py-2.5 rounded-lg border-2 border-gray-200 text-sm focus:outline-none focus:border-olive transition"
            />
          </div>
          ...
          <select
            ...
            className="px-3 py-2.5 rounded-lg border-2 border-gray-200 text-sm focus:outline-none focus:border-olive transition bg-cream"
          >
